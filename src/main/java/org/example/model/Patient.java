...
public class Patient {
    ...
    public boolean equals(Object o) {
        ...
        return getAge() == patient.getAge() && getNumberOfLowPriorityProblems() == patient.getNumberOfLowPriorityProblems() && getNumberOfMediumPriorityProblems() == patient.getNumberOfMediumPriorityProblems() && getNumberOfHighPriorityProblems() == patient.getNumberOfHighPriorityProblems() && Objects.equals(getFirstName(), patient.getFirstName()) && Objects.equals(getLastName(), patient.getLastName()) && getGender() == patient.getGender() && Objects.equals(getBirthPlace(), patient.getBirthPlace()) && Objects.equals(getDateOfBirth(), patient.getDateOfBirth());
    }

    @Override
    public int hashCode() {
        return Objects.hash(getFirstName(), getLastName(), getAge(), getGender(), getBirthPlace(), getDateOfBirth(), getNumberOfLowPriorityProblems(), getNumberOfMediumPriorityProblems(), getNumberOfHighPriorityProblems());
    }
}
